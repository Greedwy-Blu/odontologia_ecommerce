...
<div className="    ">
      ...
      <div className="flex  justify-end mt-28 md:max-h-screen md:max-w-screen  sm:max-h-screen sm:max-w-screen">
...
<div className="flex lg:justify-end sm:justify-start lg:justify-around lg:ml-36 sm:ml-36 ">
      <div className="bg-emerald-700 w-24 h-1/4 rounded-tl-lg rounded-bl-lg rounded-br-lg drop-shadow-xl  "><a className="pl-4 "><Image  src={imIcon2} width="64" height="64" className=' object-center overflow-hidden' />
</a></div>
</div>
